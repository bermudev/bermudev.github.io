...
To learn more about the installation process we can follow the instructions in [its repository](https://github.com/pyenv/pyenv#installation). In general, we can use its installation script:
