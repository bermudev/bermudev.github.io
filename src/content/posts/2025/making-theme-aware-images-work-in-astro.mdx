...
> [!warning] Use inversion selectively
> Do not apply this treatment automatically to photographs, screenshots, or diagrams with meaningful colors. Check the image in both themes and enable inversion only when it improves visibility without distorting the content.
...
* `data-invert-on-light` → improves light-mode visibility for light assets
