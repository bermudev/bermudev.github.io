...
modDatetime: 2026-08-29T00:42:23.000+02:00
featured: false
...
By default, it runs on `http://localhost:5555`. Flower exposes operational data and remote-control features, so enable authentication and avoid exposing it directly to the public internet in production.
