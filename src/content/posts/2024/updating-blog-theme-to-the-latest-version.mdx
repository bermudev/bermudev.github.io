...
pubDatetime: 2024-09-27T22:00:00.000Z
tags: [astro, blogging, theme customization, git, vscode]
draft: false
author: Carlos Bermudez
slug: updating-blog-theme-to-the-latest-version
---
...
Finally, after some test and error on how to deal with the update I think I have found the best way and I have been able to do the update without too many problems.
...
> [!danger] Back up the repository first
> The following procedure deletes and replaces most of the working tree. Use a disposable branch, make a verified backup, confirm that you are operating in the intended repository, and never remove its `.git` directory.
...
6. Copy the entire contents of the **theme** repository (with the .git deleted) to our **personal blog** repository folder (it should be empty except for our .git folder).
