...
pubDatetime: 2024-02-13T00:00:00.000Z
...
tags: [python, error handling, lbyl, eafp]
author: Carlos Bermudez
slug: preventing-vs-handling-errors-in-python
---
...
> [!warning] Catch specific exceptions
> The bare `except:` above is only a conceptual example. In real Python code, catch the specific exceptions you expect so that unrelated failures are not silently hidden.
