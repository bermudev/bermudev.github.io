...
tags: [python, opencv, stockfish, automation, computer vision, personal project]

ogImage: "../../../assets/images/chess-bot-cover.jpg"
author: Carlos Bermudez
slug: creating-a-chess-bot-to-beat-my-fide-master-friend
---

import { Image } from "astro:assets";
import board from "@/assets/images/chess-bot-board.png";
import board_threshold from "@/assets/images/chess-bot-board-threshold.png";
import score from "@/assets/images/chess-bot-score.png";
...
> [!warning] The repository is intentionally incomplete
> The working implementations responsible for locating the chessboard and reading its pieces have been intentionally omitted from the public code to discourage its use as a ready-to-run cheating tool.
>
> However, the explanation is still here.
>
> I created this project as a joke with a friend and shared it for educational purposes only.
