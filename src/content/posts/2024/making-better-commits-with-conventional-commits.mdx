...
pubDatetime: 2024-03-14T23:00:00.000Z
tags: [git, conventional commits, version control, automation]
draft: false
author: Carlos Bermudez
slug: making-better-commits-with-conventional-commits
---

import { Image } from "astro:assets";
import git_commit from "@/assets/images/conventional-commits-xkcd.png";
...
If we want, we can also **integrate** Conventional Commits with another commit convention (yes... I know) like [Gitmoji](https://github.com/carloscuesta/gitmoji), which is an initiative to standardize and explain the use of **emojis** on GitHub commit messages. 
