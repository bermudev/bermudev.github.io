...
pubDatetime: 2024-08-09T22:00:00.000Z
tags: [aws cdk, typescript, python, infrastructure as code, devops]
draft: false
author: Carlos Bermudez
slug: first-steps-with-aws-cloud-development-kit
---
import { Image } from 'astro:assets';
import picture from "@/assets/images/aws-cdk-app-stacks.png";
import logo from "@/assets/images/aws-cdk-logo.png";
...
```python file="my_cdk_project/my_cdk_project_stack.py"
from aws_cdk import (
    Stack,
    aws_s3 as s3
)
...
> [!danger] Destructive removal policy
> This example creates a versioned S3 bucket with S3-managed encryption, but it also sets `removal_policy` to `DESTROY`. Destroying the stack can therefore delete the bucket and its data. Use this setting only when that behavior is intentional and the data is disposable or safely backed up.
