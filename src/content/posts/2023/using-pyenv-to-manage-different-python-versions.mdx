...
pubDatetime: 2023-10-19T00:00:00.000Z
description: "Manage Python versions easily with Pyenv and virtual environments. Avoid conflicts between projects."
tags: [pyenv, python, development environment, virtual environments]
author: Carlos Bermudez
slug: using-pyenv-to-manage-different-python-versions
---
...
After installation there is an additional step that is supposed to be done automatically, but in my case I have found that sometimes I have to do it manually. It is really simple: when it is done installing, you have to configure it for the SHELL you are using.
...
```
You can find the configuration for other shells in the [Pyenv repository](https://github.com/pyenv/pyenv#set-up-your-shell-environment-for-pyenv).

> [!tip] Reload your shell
> After updating the configuration, restart the terminal or reload the corresponding file with `source` before trying to use Pyenv.
...
Additionally, to check the version of Python being used and the location:
