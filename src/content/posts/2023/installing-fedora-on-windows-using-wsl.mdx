...
modDatetime: 2024-12-14T23:00:00.000Z
...
tags: [wsl, linux, windows, fedora]
author: Carlos Bermudez
slug: installing-fedora-on-windows-using-wsl
---
import { Image } from 'astro:assets';
import picture from "@/assets/images/fedora-wsl-windows.png";
...
> [!tip] Easier WSL installation
> On recent versions of Windows, you can install WSL directly from the console with the following command:
> 
> ```bash
> wsl --install
> ```
