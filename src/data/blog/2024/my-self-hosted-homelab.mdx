...
pubDatetime: 2024-10-18T22:00:00.000Z
tags: [self-hosted, homelab, proxmox, backup, privacy]
draft: false
author: Carlos Bermudez
slug: my-self-hosted-homelab
---

import { Image } from "astro:assets";
import diagram from "@/assets/images/homelab-diagram.png";
import server from "@/assets/images/homelab-server.webp";
