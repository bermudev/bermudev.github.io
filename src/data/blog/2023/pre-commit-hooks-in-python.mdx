...
pubDatetime: 2023-05-10T00:00:00.000Z
description: "Integrate code formatters seamlessly using Pre-commit hooks. Ensure consistent styles and catch issues early"
tags: [pre-commit, python, code quality, git]
author: Carlos Bermudez
slug: pre-commit-hooks-in-python
---

import { Image } from "astro:assets";
import picture_logo from "@/assets/images/pre-commit-logo.png";
import picture_run from "@/assets/images/pre-commit-run-example.png";
