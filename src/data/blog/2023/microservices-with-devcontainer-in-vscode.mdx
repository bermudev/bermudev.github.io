...
pubDatetime: 2023-07-21T00:00:00.000Z
description: "Explore the efficiency of DevContainer in VSCode for microservices using Docker with examples"
tags: [python, microservices, docker, devcontainer, vscode]
author: Carlos Bermudez
slug: microservices-with-devcontainer-in-vscode
---
import { Image } from 'astro:assets';
import picture from "@/assets/images/vscode-dev-containers-logo.svg";

## Table of contents

## Why DevContainer changed my workflow
